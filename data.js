...
const JAPAN_DATA = [
  ...
  },
  {
    ...
    rating: 4.8,
    keyword: "gion hanamikoji kyoto geisha machiya tea house yasaka shrine traditional",
    image: "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=1200&q=80",
    description: "ย่านประวัติศาสตร์อันทรงเสน่ห์ที่สุดของเกียวโต โดดเด่นด้วยบ้านไม้โบราณสไตล์มาจิยะ (Machiya) ถนนปูหินโคมแดง และเป็นแหล่งพบเจอเกอิชา (Geiko) และไมโกะ (Maiko) ในชุดกิโมโนงดงาม",
    transport: "🚇 เดิน 3 นาทีจากสถานี Gion-Shijo (Keihan Main Line) หรือสถานี Kyoto Kawaramachi (Hankyu Kyoto Line ทางออก 1B)",
    bestTime: "16:30 - 20:30 น. ช่วงหัวค่ำโคมไฟหน้าบ้านไม้สว่างไสว บรรยากาศโรแมนติกสไตล์ย้อนยุค",
    foodTips: "ชิมพาร์เฟต์ชาเขียวมัทฉะเข้มข้นร้าน Tsujiri Honten, ขนมวากาชิโบราณ Kagizen Yoshifusa, ข้าวหน้าเนื้อเกียวโต",
    estimatedCost: "เดินชมย่านฟรี | ขนม & คาเฟ่ 1,000 - 2,000 เยน | ร้านอาหารไคเซกิ 5,000 - 15,000 เยน",
    mustTry: ["เดินถ่ายรูปบนถนนปูหินฮานามิโคจิยามค่ำคืน", "แวะขอพรที่ศาลเจ้ายาซากะ (Yasaka Shrine)", "ทานพาร์เฟต์ชาเขียวมัทฉะแท้เกียวโต"],
    nearbyHotels: [
      {
        name: "OMO5 Kyoto Gion by Hoshino Resorts",
        japanese: "OMO5 京都祇園 by 星野リゾート",
        type: "โรงแรมดีไซน์พรีเมียมใจกลางย่านกิออน",
        distance: "เดิน 1 นาทีถึงศาลเจ้ายาซากะ / กิออน",
        priceJPY: 26000,
        priceRange: "¥20,000 - ¥36,000 / คืน",
        rating: 4.9,
        highlight: "มีกิจกรรมทัวร์เดินชมเมืองกิออนยามเช้า ห้องพักกว้างตกแต่งสไตล์เกียวโตโมเดิร์น พร้อมครัวขนาดเล็ก",
        searchQuery: "OMO5 Kyoto Gion by Hoshino Resorts"
      },
      {
        name: "The Celestine Kyoto Gion",
        japanese: "ホテル ザ セレスティン京都祇園",
        type: "โรงแรมหรูบรรยากาศเงียบสงบสไตล์ญี่ปุ่น",
        distance: "เดิน 5 นาทีถึงถนนฮานามิโคจิ",
        priceJPY: 32000,
        priceRange: "¥25,000 - ¥45,000 / คืน",
        rating: 4.8,
        highlight: "มีบ่ออาบน้ำรวมขนาดใหญ่พร้อมสวนหิน บรรยากาศหรูหราสงบเป็นส่วนตัว อาหารเช้าสไตล์เกียวโตเลิศรส",
        searchQuery: "Hotel The Celestine Kyoto Gion"
      },
      {
        name: "Sora Niwa Terrace Kyoto",
        japanese: "四条河原町温泉 空庭テラス京都",
        type: "โรงแรมออนเซ็นธรรมชาติพร้อมรูฟท็อปวิวแม่น้ำคาโมะ",
        distance: "เดิน 4 นาทีข้ามสะพานถึงย่านกิออน",
        priceJPY: 24000,
        priceRange: "¥18,000 - ¥32,000 / คืน",
        rating: 4.8,
        highlight: "มีบ่อออนเซ็นน้ำแร่ธรรมชาติ และรูฟท็อปเทอร์เรซชมวิวแม่น้ำ Kamo River และภูเขาฮิกาชิยามะ",
        searchQuery: "Sora Niwa Terrace Kyoto"
      }
    ]
  },
...
const ROUTE_SIMULATION_META = {
  ...
  "kyoto-gion-hanamikoji": {
    station: "สถานี Gion-Shijo (Keihan เดิน 3 นาที)",
    city: "เกียวโต",
    region: "kyoto",
    lat: 35.0037,
    lng: 135.7753,
    svgPos: { x: 49, y: 68 },
    stayHours: "2 - 3 ชม.",
    bestTimeOfDay: "16:30 - 20:30 น.",
    icon: "🏮",
    mapsName: "Gion Hanamikoji Street, Kyoto"
  },
  "fuji-kawaguchiko": {
